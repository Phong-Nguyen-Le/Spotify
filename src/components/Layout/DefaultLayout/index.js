...
function DefaultLayout({ children }) {
    ...
    return (
        <div>
            <Header />
            <Sidebar />
            <div className="grid grid-cols-3 bg-slate-600 ml-[250px] max-xl:ml-[20%] max-lg:ml-[30%] max-md:ml-[80px] home-background" >
                {children}
                <div className="h-[88px]"></div>
            </div>
            {/* FOOTER */}
            <div className="w-screen grid grid-cols-12 max-md:grid-cols-3 player-music fixed bottom-0 ">
